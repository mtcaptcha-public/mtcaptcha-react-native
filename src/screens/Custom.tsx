  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.header}>Custom Login</Text>
        <View style={styles.separator} />
        <TextInput
          style={styles.input}
        ...
        <View style={styles.webViewContainer}>
          <MTCaptcha
            onCaptchaVerified={(event) => onCaptchaVerified(event)}
            ...
            customLangText={{
              en: {
                inputPrompt: "custom placeholder text",
              },
            }}
            customStyle={{
              cardColor: "#33383B",
